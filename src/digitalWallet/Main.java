...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		// dir.mkdir();
		String batchFile = "../DigitWallet/paymo_input/batch_payment.csv";
		String streamFile = "../DigitWallet/paymo_input/stream_payment.csv";
		String outputFile1 = "../DigitWallet/paymo_output/output1.txt";
		String outputFile2 = "../DigitWallet/paymo_output/output2.txt";
		String outputFile3 = "../DigitWallet/paymo_output/output3.txt";

		// Feature 1
		// System.out.println("Feature 1:");
		//
		// System.out.println("reading batch_payment.csv....");
		// HashMap<Integer, ArrayList<Integer>> batchUserMap =
		// reader.readMap(batchFile);
